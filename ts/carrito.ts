...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const cartContainer = document.getElementById("cart-body") as HTMLElement;
...
const updateCarQuantity = (productId: string, newQuantity: number) => {
...
function refreshPriceRow(productId: string) {
